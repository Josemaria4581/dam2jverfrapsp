package com.mycompany.clienteftp1;
...
public class GestorFTP {
    ...
    private static final String USUARIO = "dam2pspjverfra";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            boolean subido = gestorFTP.subirFichero("C:\\Users\\Alumno\\Documents\\prueba.txt");
            if (subido) {
            ...
            boolean descargado = gestorFTP.descargarFichero(
                    "prueba.txt",
                    "C:\\Users\\Alumno\\Documents\\prueba_descargada.txt"
            );
            if (descargado) {
